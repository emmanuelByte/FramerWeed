        ...
        <motion.form variants={childVariants} className="pl-4">
          <div className="flex flex-col">
            ...
            <input
              ...
              type="text"
              name="name"
              className="px-3 py-4 w-1/2 border-2 rounded-lg shadow-md"
              id="name"
              placeholder="name"
            />
          </div>
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              type="text"
              name="phone"
              className="px-3 py-4 w-full rounded-lg shadow-md border-2"
              id="phone"
              placeholder="phone number"
            />
          </div>
        </motion.form>
        <button className="text-xl py-3 active:bg-gray-200 border-2 px-3 rounded-xl mt-6 ">
          Add user
        </button>
        <motion.div variants={childVariants}></motion.div>
      </div>
