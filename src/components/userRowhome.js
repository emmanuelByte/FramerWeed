    ...
    <tr key={id}>
      ...
      <td className=" flex justify-between ">
        ...
        <span className=" space-x-2 flex">
          <Link
            to="/view"
            className="border-2 rounded-lg px-1 active:bg-gray-200"
          >
            view
          </Link>
          <Link to={`/edit${id}`}>
            <button className="border-2 bg-yellow-200 active:bg-yellow-500  rounded-lg px-1">
              edit
            </button>
          </Link>
          <button
            onClick={deleteUser}
            className="border-2 rounded-lg bg-red-500 active:bg-red-800 px-1"
          >
            delete
          </button>
        </span>
